...
- **Клиент:** `Services/Dashboard/DatabaseSyncService`
- **Retry:** Polly, 3 попытки (1/2/4 с)
- **Ожидаемые ответы:** `204 No Content`, `400 Bad Request`, `401 Unauthorized`
...
- **Клиент:** `Services/Dashboard/FileSetSyncService`
- **Retry:** Polly, 3 попытки (1/2/4 с)
- **Ожидаемые ответы:** `204 No Content`, `400 Bad Request`, `401 Unauthorized`
...
| `POST /databases`               | `Services/Dashboard/DatabaseSyncService.BuildPayload`        |
| `POST /filesets`                | `Services/Dashboard/FileSetSyncService.BuildPayload`         |
| `GET /task`                     | —                                                            |
