...
public sealed class S3BackupIntegrationTests
{
    ...
    public async Task SetUp()
    {
        ...
        {
            EndpointUrl = _baseSettings.EndpointUrl,
            AccessKey = _baseSettings.AccessKey,
            SecretKey = _baseSettings.SecretKey,
            Region = _baseSettings.Region,
            BucketName = _bucket,
        };
    ...
    public async Task ChunkGc_AfterManifestDeletion_RemovesOrphanedChunks()
    {
        ...
        Assert.That(chunksBefore, Is.GreaterThan(0));
